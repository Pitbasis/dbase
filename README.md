...
It includes a self-installation routine that automatically moves the script to /usr/local/bin, so once you've set the execution permissions with chmod +x dbase.sh, you can just run dbase as a global command from anywhere in your system. It’s designed to be simple, fast, and stay out of your way while you work.

<img width="1249" height="560" alt="image" src="https://github.com/user-attachments/assets/b2c490de-669d-42de-ab0a-cbface732391" />
